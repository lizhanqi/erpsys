...
public class DialogCreator {
    ...
    public static Dialog createLongPressMessageDialog(Context context, String title, boolean hide,
        ...
        Button copyBtn = view.findViewById(IdHelper.getViewID(context, "jmui_copy_msg_btn"));
        Button forwardBtn = view.findViewById(IdHelper.getViewID(context, "jmui_forward_msg_btn"));
        ...
        Button deleteBtn = view.findViewById(IdHelper.getViewID(context, "jmui_delete_msg_btn"));
        final TextView titleTv = view.findViewById(IdHelper.getViewID(context, "jmui_dialog_title"));
        if (hide) {
