package com.suxuantech.erpsys.chat.location.activity;
...
import com.suxuantech.erpsys.chat.location.BitmapLoader;
import com.suxuantech.erpsys.chat.location.adapter.MapPickerAdapter;
...
public class MapPickerActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout = findViewById(R.id.listNearbyHolder);
        ...
        String targetId = getIntent().getStringExtra("tagetId");
        String targetAppKey = getIntent().getStringExtra("targetAppKey");
                ...
                mBaiduMap.snapshotScope(rect, new BaiduMap.SnapshotReadyCallback() {
                    ...
                    public void onSnapshotReady(Bitmap bitmap) {
                        if (null != bitmap && null != conv) {
                            ...
                            Toast.makeText(getBaseContext(), getString(R.string.send_location_error),
