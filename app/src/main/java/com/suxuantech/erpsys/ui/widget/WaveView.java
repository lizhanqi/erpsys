...
public class WaveView extends View {
    ...
    public static final int DEFAULT_TEXT_COLOR = Color.parseColor("#f2000000");
  ...
  private boolean mShowWave;
    ...
    private int mTextColor = DEFAULT_BG_COLOR;
     ...
     *                       BaseResult of waveShiftRatio multiples width of WaveView is the length to shift.
     */
     ...
     *
     * @param amplitudeRatio Default to be 0.05. BaseResult of amplitudeRatio + waterLevelRatio should be less than 1.
    ...
    public void setBgroundColor(int color){
    ...
    public void setWaveColor(int behindWaveColor, int frontWaveColor,int colorBG) {
        mBehindWaveColor = behindWaveColor;
        mFrontWaveColor = frontWaveColor;
        mBackgroundColor=colorBG;
        if (getWidth() > 0 && getHeight() > 0) {
            // need to recreate shader when color changed
            mWaveShader = null;
            createShader();
        ...
        if (mShowWave && mWaveShader != null) {
            ...
            switch (mShapeType) {
                ...
                case CIRCLE:
                    ...
                    circlePaint.setColor(mBackgroundColor);
                    canvas.drawCircle(getWidth() / 2,getWidth() / 2,radius,circlePaint);//实现背景色
                ...
                case SQUARE:
                    ...
                    canvas.drawColor(mBackgroundColor);//实现背景色
                    if (borderWidth > 0) {
                        canvas.drawRect(
                            borderWidth / 2f,
                            borderWidth / 2f,
