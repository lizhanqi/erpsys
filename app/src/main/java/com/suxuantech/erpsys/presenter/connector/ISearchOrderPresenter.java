...
public interface ISearchOrderPresenter {
     ...
     */
    void searchSucceed(List<SearchOrderBean.DataBean> data, boolean isRefesh, boolean hasMore);
     ...
     */
    void searchFailed(Response<SearchOrderBean> response, int pageIndex);
}
