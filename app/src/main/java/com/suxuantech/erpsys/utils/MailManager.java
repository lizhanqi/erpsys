...
/**
 * 邮件管理类
 *注意1.这里的邮箱必须开通了stmp服务，该例是以163邮箱为例，其他邮箱VALUE_MAIL_HOST替换为对应的邮箱。2.这里的密码是邮箱smtp的客户端授权码
 * Created by DevWiki on 2016/8/21.
 */
@SuppressWarnings("ALL")
public class MailManager {
    private static final String SENDER_NAME = "lizhanqihd@163.com";
    private static final String SENDER_PASS = "lzq047589";
