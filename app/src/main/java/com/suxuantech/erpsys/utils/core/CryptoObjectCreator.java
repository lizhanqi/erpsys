...
public class CryptoObjectCreator {
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            L.d("Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                    L.d(" Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            L.d(" Failed to createKey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            L.d(" Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;
